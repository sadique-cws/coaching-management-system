...
const DurationForm = ({initialData, courseId}) => {
  ...
  return (
    <div className="mt-6 bg-slate-100 rounded-md dark:bg-gray-800 p-3">
        ...
        {!isEditing && (
                <p className={cn("text-sm mt-2 dark:text-gray-300", !initialData.duration && "italic text-slate-500")}>
                    {formatDuration(initialData?.duration) || "Duration not set for this course"}
                </p>
            )}
